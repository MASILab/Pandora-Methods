...
% try
    ...
    A={'fmajor_PP_avg33_mni_bbr';'fminor_PP_avg33_mni_bbr';'lh.atr_PP_avg33_mni_bbr';'lh.cab_PP_avg33_mni_bbr';'lh.ccg_PP_avg33_mni_bbr';...
        'lh.cst_AS_avg33_mni_bbr';'lh.ilf_AS_avg33_mni_bbr';'lh.slfp_PP_avg33_mni_bbr';'lh.slft_PP_avg33_mni_bbr';'lh.unc_AS_avg33_mni_bbr'; ...
        'rh.atr_PP_avg33_mni_bbr';'rh.cab_PP_avg33_mni_bbr';'rh.ccg_PP_avg33_mni_bbr';'rh.cst_AS_avg33_mni_bbr';'rh.ilf_AS_avg33_mni_bbr'; ...
        'rh.slfp_PP_avg33_mni_bbr';'rh.slft_PP_avg33_mni_bbr';'rh.unc_AS_avg33_mni_bbr'};
    paths=A;
    

    bundles_path = [folder filesep 'derivatives' filesep 'tracula' filesep 'dpath'];
    b0_path = [folder filesep 'dwi' filesep 'b0.nii.gz'];
    TIFF_NAME = [folder filesep 'QA' filesep 'TraculaQA'];
    ...
    for i = 1:length(paths)
        ...
        try
            ...
            pred = [bundles_path filesep paths{i} filesep 'path.pd.nii.gz'];
