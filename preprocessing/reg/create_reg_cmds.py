...
d = '/nfs/masi/hansencb/t1_tract_data/raw_data/NORMAL'

atlas_path = '/scratch/hansencb/tract_preprocessing/mni_icbm152_t1_tal_nlin_asym_09c.nii.gz'
script_path = '/scratch/hansencb/tract_preprocessing/Registration2Atlas.sh'
singularity_path = '/scratch/hansencb/tract_preprocessing/reg.simg'
work_dir = '/scratch/hansencb/tract_preprocessing/'
cmd = 'mkdir -p {} && scp -r hickory:{} {} && scp hickory:{} {} && ' \
      'singularity exec {} {} {} {} {} {} && scp -r {} hickory:{} && rm -rf {} && rmdir {}\n'

out_file = 'reg_NORMAL_cmds.txt'
        ...
        if os.path.isdir(subj_dir):
            for sess in os.listdir(subj_dir):
                ...
                if os.path.isdir(sess_dir):
                    ...
                    out_path = os.path.join(sess_dir, 'reg')
