...
cmd = '/scratch/hansencb/tract_preprocessing/AFQ/Atlas_OrganizeAFQclipped_ACCRE.sh {} {} {}\n'

out_file = 'afqclipped_transform_cmds.txt'
        ...
        for subj in os.listdir(d):
            ...
            if os.path.isdir(subj_dir):
                for sess in os.listdir(subj_dir):
                    ...
                    if os.path.isdir(os.path.join(sess_dir, 'derivatives', 'AFQ_clipped')):
                        linear_out = os.path.join(out_dir, 'AFQclippedLinear', '{}_{}_{}'.format(proj,subj,sess))
                        nonlin_out = os.path.join(out_dir, 'AFQclippedNonlinear', '{}_{}_{}'.format(proj, subj, sess))
